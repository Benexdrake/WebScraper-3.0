...
namespace Webscraper_API.Scraper.TCG_Magic.Controller
{
    public class TCG_M_API : ITCG_M_API
    {
        ...
        public async Task<Set> GetSet(string name)
        {
            ...
            string url = $"https://api.scryfall.com/sets/{split[4]}";
            ...
            try
            {
                using (HttpClient client = new HttpClient())
                {
                                ...
                                url).Result)
                    {
                        ...
                        var set = JsonConvert.DeserializeObject<Set>(responseBody);
        ...
        public async Task<Card> GetCard(string url)
        {
            try
            {
                using (HttpClient client = new HttpClient())
